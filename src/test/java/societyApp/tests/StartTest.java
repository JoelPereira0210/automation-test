...
public class StartTest {
	...
	public void setup() throws InterruptedException, IOException {
		...
		subscriptions = JsonDataReader.getSubscriptions();
	}
	...
	public void createSubscriptions() throws Exception {
		for (SubscriptionData sub : subscriptions) {
			...
			WebElement publishButton = wait
					.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[normalize-space()='Publish']")));
			publishButton.click();
		...
		System.out.println("All subscriptions processed.");
	}

	@Test(priority = 3)
	public void validateSubscriptions() {
		System.out.println("Validating subscriptions...");
		// Add validation logic here (e.g., check if subscriptions are displayed in the
		// table).
	}
	...
	public void cleanup() {
		...
		// Add cleanup logic here (e.g., delete test subscriptions).
	}
